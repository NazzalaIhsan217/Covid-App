package com.twilighttwig.covidapp
...
import com.twilighttwig.covidapp.network.InfoService
...
class ChartCountryActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        sharePreferences=this.getSharedPreferences(sharedPrefile,Context.MODE_PRIVATE)

        //format angka yang di tampilkan
        ...
        data?.let {
            ...
            //get data yang terupdate
            latest_update.text=data.Date


            //berita baru (angka) tentang covid
    ...
    private fun getCountry() {
        ...
        val oktthp=OkHttpClient().newBuilder()
